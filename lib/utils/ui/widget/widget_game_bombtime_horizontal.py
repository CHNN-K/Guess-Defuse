...
class Widget_Game_Bombtime_Horizontal(CTkFrame):
    ...
    def build_ui(self):
        ...
        self.frame_bar.grid_columnconfigure((0,2,4,6,8,10,12,14,16), weight = 0)
        self.frame_bar.grid_columnconfigure((1,3,5,7,9,11,13,15), weight = 0, minsize = 5)
